...
import com.dirac.demo.invoice.config.audit.AuditEventConverter;
import com.dirac.demo.invoice.domain.PersistentAuditEvent;
...
import static com.dirac.demo.invoice.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
